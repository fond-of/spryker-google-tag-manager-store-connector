...
class SpyCurrencyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Orm.Zed.Currency.Persistence.Map.SpyCurrencyTableMap';
     ...
     */
    const CLASS_DEFAULT = 'Orm.Zed.Currency.Persistence.SpyCurrency';
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyCurrencyTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyCurrencyTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyCurrencyTableMap());
        }
    }
...
//
SpyCurrencyTableMap::buildTableMap();
