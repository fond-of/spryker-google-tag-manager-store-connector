 ...
 *
 * @method     ChildSpyCurrency|null|null findOne(ConnectionInterface $con = null) Return the first ChildSpyCurrency matching the query
 ...
 *
 * @method     ChildSpyCurrency|null|null findOneByIdCurrency(int $id_currency) Return the first ChildSpyCurrency filtered by the id_currency column
 * @method     ChildSpyCurrency|null|null findOneByName(string $name) Return the first ChildSpyCurrency filtered by the name column
 * @method     ChildSpyCurrency|null|null findOneByCode(string $code) Return the first ChildSpyCurrency filtered by the code column
 * @method     ChildSpyCurrency|null|null findOneBySymbol(string $symbol) Return the first ChildSpyCurrency filtered by the symbol column *
