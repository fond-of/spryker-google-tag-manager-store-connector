 ...
 *
 * @method     ChildSpyStore|null|null findOne(ConnectionInterface $con = null) Return the first ChildSpyStore matching the query
 ...
 *
 * @method     ChildSpyStore|null|null findOneByIdStore(int $id_store) Return the first ChildSpyStore filtered by the id_store column
 * @method     ChildSpyStore|null|null findOneByName(string $name) Return the first ChildSpyStore filtered by the name column *
