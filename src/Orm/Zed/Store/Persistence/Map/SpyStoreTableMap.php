...
class SpyStoreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Orm.Zed.Store.Persistence.Map.SpyStoreTableMap';
     ...
     */
    const CLASS_DEFAULT = 'Orm.Zed.Store.Persistence.SpyStore';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdStore', 'Name', ),
        self::TYPE_CAMELNAME     => array('idStore', 'name', ),
        self::TYPE_COLNAME       => array(SpyStoreTableMap::COL_ID_STORE, SpyStoreTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id_store', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdStore' => 0, 'Name' => 1, ),
        self::TYPE_CAMELNAME     => array('idStore' => 0, 'name' => 1, ),
        self::TYPE_COLNAME       => array(SpyStoreTableMap::COL_ID_STORE => 0, SpyStoreTableMap::COL_NAME => 1, ),
        self::TYPE_FIELDNAME     => array('id_store' => 0, 'name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyStoreTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyStoreTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyStoreTableMap());
        }
    }
...
//
SpyStoreTableMap::buildTableMap();
