...
class SpyQueueProcessTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Orm.Zed.Queue.Persistence.Map.SpyQueueProcessTableMap';
     ...
     */
    const TABLE_NAME = 'spy_queue_process';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Orm\\Zed\\Queue\\Persistence\\SpyQueueProcess';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Orm.Zed.Queue.Persistence.SpyQueueProcess';
     ...
     */
    const COL_ID_QUEUE_PROCESS = 'spy_queue_process.id_queue_process';

    /**
     * the column name for the server_id field
     */
    const COL_SERVER_ID = 'spy_queue_process.server_id';

    /**
     * the column name for the process_pid field
     */
    const COL_PROCESS_PID = 'spy_queue_process.process_pid';

    /**
     * the column name for the worker_pid field
     */
    const COL_WORKER_PID = 'spy_queue_process.worker_pid';

    /**
     * the column name for the queue_name field
     */
    const COL_QUEUE_NAME = 'spy_queue_process.queue_name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'spy_queue_process.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'spy_queue_process.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdQueueProcess', 'ServerId', 'ProcessPid', 'WorkerPid', 'QueueName', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idQueueProcess', 'serverId', 'processPid', 'workerPid', 'queueName', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyQueueProcessTableMap::COL_ID_QUEUE_PROCESS, SpyQueueProcessTableMap::COL_SERVER_ID, SpyQueueProcessTableMap::COL_PROCESS_PID, SpyQueueProcessTableMap::COL_WORKER_PID, SpyQueueProcessTableMap::COL_QUEUE_NAME, SpyQueueProcessTableMap::COL_CREATED_AT, SpyQueueProcessTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_queue_process', 'server_id', 'process_pid', 'worker_pid', 'queue_name', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdQueueProcess' => 0, 'ServerId' => 1, 'ProcessPid' => 2, 'WorkerPid' => 3, 'QueueName' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('idQueueProcess' => 0, 'serverId' => 1, 'processPid' => 2, 'workerPid' => 3, 'queueName' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(SpyQueueProcessTableMap::COL_ID_QUEUE_PROCESS => 0, SpyQueueProcessTableMap::COL_SERVER_ID => 1, SpyQueueProcessTableMap::COL_PROCESS_PID => 2, SpyQueueProcessTableMap::COL_WORKER_PID => 3, SpyQueueProcessTableMap::COL_QUEUE_NAME => 4, SpyQueueProcessTableMap::COL_CREATED_AT => 5, SpyQueueProcessTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id_queue_process' => 0, 'server_id' => 1, 'process_pid' => 2, 'worker_pid' => 3, 'queue_name' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyQueueProcessTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyQueueProcessTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyQueueProcessTableMap());
        }
    }
...
} // SpyQueueProcessTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
SpyQueueProcessTableMap::buildTableMap();
