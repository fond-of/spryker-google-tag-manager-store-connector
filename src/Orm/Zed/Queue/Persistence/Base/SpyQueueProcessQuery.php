 ...
 *
 * @method     ChildSpyQueueProcess|null|null findOne(ConnectionInterface $con = null) Return the first ChildSpyQueueProcess matching the query
 ...
 *
 * @method     ChildSpyQueueProcess|null|null findOneByIdQueueProcess(int $id_queue_process) Return the first ChildSpyQueueProcess filtered by the id_queue_process column
 * @method     ChildSpyQueueProcess|null|null findOneByServerId(string $server_id) Return the first ChildSpyQueueProcess filtered by the server_id column
 * @method     ChildSpyQueueProcess|null|null findOneByProcessPid(int $process_pid) Return the first ChildSpyQueueProcess filtered by the process_pid column
 * @method     ChildSpyQueueProcess|null|null findOneByWorkerPid(int $worker_pid) Return the first ChildSpyQueueProcess filtered by the worker_pid column
 * @method     ChildSpyQueueProcess|null|null findOneByQueueName(string $queue_name) Return the first ChildSpyQueueProcess filtered by the queue_name column
 * @method     ChildSpyQueueProcess|null|null findOneByCreatedAt(string $created_at) Return the first ChildSpyQueueProcess filtered by the created_at column
 * @method     ChildSpyQueueProcess|null|null findOneByUpdatedAt(string $updated_at) Return the first ChildSpyQueueProcess filtered by the updated_at column *
