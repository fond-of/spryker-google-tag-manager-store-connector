 ...
 *
 * @method     ChildSpyLocale|null|null findOne(ConnectionInterface $con = null) Return the first ChildSpyLocale matching the query
 ...
 *
 * @method     ChildSpyLocale|null|null findOneByIdLocale(int $id_locale) Return the first ChildSpyLocale filtered by the id_locale column
 * @method     ChildSpyLocale|null|null findOneByLocaleName(string $locale_name) Return the first ChildSpyLocale filtered by the locale_name column
 * @method     ChildSpyLocale|null|null findOneByIsActive(boolean $is_active) Return the first ChildSpyLocale filtered by the is_active column *
