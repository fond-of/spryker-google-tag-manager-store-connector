...
/**
 * @todo: not store based plugin, move to own package (i.e. CrossEngage)
 *
 * @method \FondOfSpryker\Yves\GoogleTagManagerStoreConnector\GoogleTagManagerStoreConnectorFactory getFactory()
 */
class StoreCustomerEmailHashDataLayerExpanderPlugin extends AbstractPlugin implements GoogleTagManagerDataLayerExpanderPluginInterface
{
    /**
    ...
    public function expand(string $page, array $twigVariableBag, array $variableList): array
    {
        return $this->getFactory()
            ...
            ->getEmailHash($page, $twigVariableBag, $variableList);
    }
}
